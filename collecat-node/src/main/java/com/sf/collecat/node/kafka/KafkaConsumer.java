...
public class KafkaConsumer {
    public static void main(String[] args) throws KafkaException {
        ...
        // KAFKA连接地址
        String url = "http://mommon_other.intsit.sfdc.com.cn:1080/mom-mon/monitor/requestService.pub";
        // 集群名称
        String clusterName = "other";
        // 消费系统名称+分隔符（固定不变）+消费系统的校验码
        String systemIdToken = "SGS_TT_DEL_ORD:6o2M6V^5";
