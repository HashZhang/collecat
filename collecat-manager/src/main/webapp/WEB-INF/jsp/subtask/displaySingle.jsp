            ...
            <div class="box box-primary">
                <div class="box-header">
                    <%
                        ...
                        out.println(StrUtils.makeString("<h3 class=\"box-title\"> SUBTASK-", subtask.getId(), "</h3>"));
                    %>

                </div>
                <div class="box-body">
                    <div class="col-lg-2 col-sm-2">
                        <button onclick="startSubtask()" type="button" class="btn btn-block btn-success" <%
                    ...
                    <div class="col-lg-2 col-sm-2">
                        <button onclick="stopSubtask()" type="button" class="btn btn-block btn-danger"<%
                            if (!subtask.getIsActive()) {
                                out.print("disabled");
                            }
                        %>>关闭
                    ...
                    <table id="subtask" class="table table-bordered table-striped" cellspacing="1" width="100%">
                        ...
                        <tr>
                            <td>Schema Used:</td>
                            <td><%out.print(subtask.getSchemaUsed());%></td>
                        </tr>
                        <tr>
                            <td>Initial SQL:</td>
                            <td><%out.print(subtask.getInitialSql());%></td>
                        </tr>
                        <tr>
                            <td>Time Field:</td>
                            <td><%out.print(subtask.getTimeField());%></td>
                        </tr>
                        <tr>
                            <td>Routine Time:</td>
                            <td><%out.print(subtask.getRoutineTime());%></td>
                        </tr>
                        <tr>
                            <td>Allocate Routine:</td>
                            <td><%out.print(subtask.getAllocateRoutine());%></td>
                        </tr>
                        <tr>
                            <td>Active?:</td>
                            ...
                            <td><div class="col-xs-6 col-md-3 text-center">
                                <div style="display: inline; width: 90px; height: 90px;">
                                    ...
                                    Date startTime =  (Date) request.getAttribute("startTime");
                                        out.print(subtask.getCurrentCompletePercent(startTime));
                        ...
                        <tr>
                            ...
                            <td><div class="col-xs-6 col-md-3 text-center">
                                <div style="display: inline; width: 90px; height: 90px;">
                                    <input type="text" class="knob" value="<%
                                        out.print(subtask.getTotalCompletePercent(startTime));
                                    %>" data-width="90" data-height="90" readOnly="true" data-fgcolor="#3c8dbc" style="width: 49px; height: 30px; position: absolute; vertical-align: middle; margin-top: 30px; margin-left: -69px; border: 0px; font-weight: bold; font-style: normal; font-variant: normal; font-stretch: normal; font-size: 18px; line-height: normal; font-family: Arial; text-align: center; color: rgb(60, 141, 188); padding: 0px; -webkit-appearance: none; background: none;">
                                </div>
                            </div></td>
                        </tr>
